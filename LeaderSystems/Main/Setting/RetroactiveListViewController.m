...
- (void)getRetroactiveListWithRefreshMode:(RefreshMode)refreshMode {
    ...
    [RXApiServiceEngine requestWithType:RequestMethodTypePost url:kUrl_RetroactiveList parameters:params completionHanlder:^(id jsonData, NSError *error) {
        if (jsonData) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    RetroListModel *model = self.retroListArr[indexPath.row];
    RetroactiveDetailViewController*pushVc = [RetroactiveDetailViewController new];
