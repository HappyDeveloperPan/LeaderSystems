...
- (void)retrieveBtnClick {
    ...
    parameters[@"new_leader_account_password"] = [Common encryptString:self.passField.text publicKey:PublicKey];
//    NSLog(@"%@",[Common decryptString:[Common encryptString:self.passField.text publicKey:PublicKey] privateKey:PrivateKey]);
