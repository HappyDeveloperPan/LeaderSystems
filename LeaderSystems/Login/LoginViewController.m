...
//    String staff_password   密码
    ...
    [UserManager loginWithPhone:self.loginTextField.text andPass:[Common encryptString:self.passwordTextField.text publicKey:PublicKey] andSuccess:^(PSUser *user, NSError *error) {
